...
async function fetchVscodeConfig(): Promise<VscodeConfig> {
  ...
  return { vscodeUrl: "", vscodePathFrom: "", vscodePathTo: "" };
}
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          title="Close"
          className="ml-auto shrink-0 rounded p-0.5 text-zinc-600 hover:text-red-400"
        >
          <X size={11} />
        </button>
      </div>
      ...
      <div className="mt-1 flex items-center gap-1 pl-5">
        ...
        {vscodeConfig.vscodeUrl && (
          <button
            ...
            className="shrink-0 rounded p-0.5 text-zinc-600 hover:text-blue-400"
          >
            <Code2 size={10} />
          </button>
        )}
